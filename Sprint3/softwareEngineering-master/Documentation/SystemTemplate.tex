...
\title{{\color{MSBlue1} \rule{\linewidth}{0.5mm}}\\[2mm] {\huge \bfseries \color{MSBlue1} Dr. Logar's Super Awesome Automatic Testing System \\II }\\[-1mm] {\color{MSBlue1}\rule{\linewidth}{0.5mm}} \\  \vfill
{\LARGE \bfseries \color{MSBlue2} Software Engineering Final Documentation }\\  \vfill 
{\color{MSBlue1} The Obfuscators} }
\author{\color{MSBlue1}  Daniel Nix \and \color{MSBlue1} Joseph Lillo \and  \color{MSBlue1} Lisa Woody }
